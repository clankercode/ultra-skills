...
| Comprehensive batch review campaign (post-implementation, heavyweight — requires user consent) | `ultra-batch-review` | Inline review or superpowers:requesting-code-review |
