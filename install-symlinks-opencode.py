#!/usr/bin/env python3
"""Install/update symlinks for ultra-* skills into OpenCode's skills dir.

OpenCode skills path: ~/.config/opencode/skills
Confirmed locally on this machine (opencode installed via bun, with pre-existing
skills subdirectories like writing-skills/, test-driven-development/). If your
OpenCode install uses a different path, edit TARGET_DIR below.
"""
import os
import sys
